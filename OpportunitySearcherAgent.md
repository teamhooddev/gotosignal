...
- target keyword
- competitor website sitemap
- beneficiery website sitemap

# Your task is to
Analyze, both websites and their sitemaps. Based on found information find content gaps in competitor website which are related as close as possible to the target keyword. 
...
# Results format
Once done provide results in the follow format:
- target keyword: {keyword}
- beneficiery website: {beneficiery_web_url}
- competitor website: {competitor_web_url}
- content topic: {content_topic}
- keyword gap: {keyword_gap}
- rationale: {rationale}
